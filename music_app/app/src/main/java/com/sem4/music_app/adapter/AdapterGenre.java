...
public class AdapterGenre extends RecyclerView.Adapter {

    private ArrayList<ItemGenre> arrayList;
    private ArrayList<ItemGenre> filteredArrayList;
    ...
    public AdapterGenre(Context context, ArrayList<ItemGenre> arrayList) {
    ...
    public ItemGenre getItem(int pos) {
    ...
    private class NameFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint.toString().length() > 0) {
                ArrayList<ItemGenre> filteredItems = new ArrayList<>();
        ...
        protected void publishResults(CharSequence constraint,
            ...
            arrayList = (ArrayList<ItemGenre>) results.values;
